...
class Code {
    ...
    static function img_code($img1, $img2, $ttf1, $code_dir)
    {
...
//        header("Content-Type:image/png");
        ...
        $linenum = 2;
        $img_arr = array($img1, $img2
//            "codegen.png",
//            "codegen0.png"
        );

        $font_arr = array();
        $font_arr[0]["fname"] = $ttf1;
//        $font_arr[0]["fname"] = "verdana.ttf";
        $font_arr[0]["size"] = 16;
        $font_arr[1]["fname"] = $ttf1;
//        $font_arr[1]["fname"] = "times.ttf";
        $font_arr[1]["size"] = 16;

        $n = rand(0,sizeof($font_arr)-1);
        $img_fn = $img_arr[rand(0, sizeof($img_arr)-1)];
//        $asdasd = $code_dir . $img_fn;
        $asdasd = 'O:\home\fourth.pro\www\img\codegen0.png';
        $asdasd2 = 'O:\home\fourth.pro\www\img\verdana.ttf';
        $im = imagecreatefrompng ($asdasd);
//        $im = imagecreatefrompng (code_dir . $img_fn);
       ...
       imagettftext ($im, $font_arr[$n]["size"], rand(-4, 4), rand(10, 45), rand(20, 35), $color, $asdasd2, self::generate_code());
